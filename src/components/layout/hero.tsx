...
export default function Hero() {
  return (
    <section className="container mx-auto text-center min-h-[calc(100dvh-65px)] flex flex-col justify-center items-center  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2]">
      ...
      <p className="mt-4 max-w-xl mx-auto text-sm md:text-lg text-foreground/60 text-center">We build cutting-edge websites and mobile apps that drive results.</p>
      <HoverBorderGradient containerClassName="rounded-full mx-auto mt-4" as="button" className="bg-background text-foreground flex items-center gap-2 group/button  ">
